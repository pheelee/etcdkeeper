...
func main() {
	...
	http.Handle("/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		http.ServeFile(w, r, rootPath+"/assets/etcdkeeper/index.html")
	}))
	http.Handle("/assets/", http.StripPrefix("/assets/", http.FileServer(http.Dir(rootPath+"/assets")))) // view static directory
